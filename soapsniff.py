...
if __name__ == '__main__':
    ...
    parser.add_option("-d", "--dev", dest="dev",
        default="eth0",
        help="device to listen on (default: eth0)", metavar="DEV")
    parser.add_option("-p", "--ports", dest="ports",
        default="80,8080",
        help="ports to listen on (default: 80,8080)", metavar="PORTS")
    parser.add_option("-w", "--ws-path", dest="ws_path", metavar="PREFIX",
        default="/",
    ...
    parser.add_option("-s", "--server", dest="server", metavar="HOST_PORT",
        help="server host and port" )
